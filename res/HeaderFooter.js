	...
	<div class="main-nav">
        <div class="nav-menu">
            <ul class="nav-links" id=navLinks>
                ...
                <li class="has-submenu">
					<a href="#" class="nav-b">Irattár</a>
					<ul class="dropdown-menu">
					<div class="menu-items">
						<li><a href="#">Dokumentumok</a></li>
						<li><a href="#">Letölthető dokumentumok</a></li>
						<li><a href="#">Vizsgakövetelmények</a></li>
						<li><a href="#">Különös közzététel</a></li>
					</div>
					</ul>
				</li>
                <li class="has-submenu">
					<a href="#" class="nav-b">Közösségi szolgálat</a>
					<ul class="dropdown-menu">
					<div class="menu-items">
						<li><a href="#">Általános</a></li>
						<li><a href="#">2024/2025-ös tanév</a></li>
						<li><a href="#">2023/2024-es tanév</a></li>
						<li><a href="#">2022/2023-as tanév</a></li>
						<li><a href="#">2021/2022-as tanév</a></li>
						<li><a href="#">2020/2021-as tanév</a></li>
						<li><a href="#">2019/2020-as tanév</a></li>
						<li><a href="#">2018/2019-as tanév</a></li>
						<li><a href="#">2017/2018-as tanév</a></li>
						<li><a href="#">2016/2017-as tanév</a></li>
						<li><a href="#">2015/2016-as tanév</a></li>
						<li><a href="#">2014/2015-as tanév</a></li>
						<li><a href="#">2013/2014-as tanév</a></li>
						<li><a href="#">Archívum</a></li>
					</div>
					</ul>
				</li>
                <li class="has-submenu">
					<a href="#" class="nav-b">Felvételi</a>
					<ul class="dropdown-menu">
					<div class="menu-items">
						<li><a href="#">Induló tagozataink – 2026/2027.</a></li>
						<li><a href="#">Angol szóbeli követelmények</a></li>
						<li><a href="#">Nyílt napok</a></li>
						<li><a href="#">Beiratkozás</a></li>
					</div>
					</ul>
				</li>
				<li class="has-submenu">
					<a href="#" class="nav-b">Menza</a>
					<ul class="dropdown-menu">
					<div class="menu-items">
						<li><a href="#">Fogyasztói elégedettség mérés a 2025-26-os I.félévre, az étkeztetési szolgáltatásról</a></li>
						<li><a href="#">2026. tavaszi szünidei ingyenes étkezés</a></li>
						<li><a href="#">Befizetési rend és árak</a></li>
						<li><a href="#">Étlap</a></li>
					</div>
					</ul>
				</li>
				<li class="has-submenu">
					<a href="#" class="nav-b">Egészségügy</a>
					<ul class="dropdown-menu">
					<div class="menu-items">
						<li><a href="#">Iskolaorvos</a></li>
						<li><a href="#">Védőnő</a></li>
						<li><a href="#">Iskolapszichológus</a></li>
						<li><a href="#">Iskolai szociális segítő</a></li>
						<li><a href="#">Ifjúságvédelem</a></li>
					</div>
					</ul>
				</li>
                <li>
					<a href="/szig/page?id=4305" class="nav-b">Kapcsolat</a>
				</li>
